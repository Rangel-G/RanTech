...
export function ColorPickerModal({ visible, initialColor, onClose, onSelectColor }: ColorPickerModalProps) {
                    ...
                    <View style={styles.contentRow}>
                        ...
                        <View style={styles.buttonsColumn}>
                            ...
                            <Pressable style={[styles.actionButton, styles.cancelButton]} onPress={onClose}>
                                <Text style={[styles.buttonText, { color: '#ff6666' }]}>Cancelar</Text>
                            </Pressable>
                        </View>
